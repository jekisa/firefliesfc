...
export const players = [
    { id: 1, name: "Budi Santoso", position: "GK", number: 1, status: "active" },
    { id: 2, name: "Andi Wijaya", position: "CB", number: 4, status: "active" },
...
export const sponsors = [
    { id: 1, name: "Warung Kopi Jaya", logo: "/images/sponsors/sponsor1.png" },
...
export const socialMedia = {
    instagram: "https://instagram.com/firefliesfc",
    tiktok: "https://tiktok.com/@firefliesfc",
